(function ($, undefined) {
    ...
    var defaults = {
        ...
        jdayNames: ['يکشنبه', 'دوشنبه', 'سه شنبه', 'چهارشنبه', 'پنجشنبه', 'جمعه', 'شنبه'],
        dayNamesShort: ['Sun', 'Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat'],
        jdayNamesShort: ['يکشنبه', 'دوشنبه', 'سه شنبه', 'چهارشنبه', 'پنجشنبه', 'جمعه', 'شنبه'],
        buttonText: {
            prev: "<span class='fc-button fc-state-disabled'>&lsaquo;</span>",
            next: "<span class='fc-button fc-state-disabled'>&rsaquo;</span>",
            prevYear: "<span class='fc-button fc-state-disabled'>&laquo;</span>",
            nextYear: "<span class='fc-button fc-state-disabled'>&raquo;</span>",
            today: 'today',
            month: 'month',
            week: 'week',
            day: 'day'
        ...
        function renderView(inc) {
            if (elementVisible()) {
                ...
                if (today >= currentView.start && today < currentView.end) {
					...
					header.disableButton('prevButton');
                } else {
...
// TODO: use same function formatDate(date, [date2], format, [options])
    ...
    var jdateFormatters = {
        ...
        dd: function (d) {
            return zeroPad(d.getJalaliDate())
        },
        ddd: function (d, o) {
            return o.jdayNamesShort[d.getJalaliDay()]
        },
        dddd: function (d, o) {
            return o.jdayNames[d.getJalaliDay()]
        },
        M: function (d) {
            return d.getJalaliMonth() + 1
        },
        MM: function (d) {
            return zeroPad(d.getJalaliMonth() + 1)
        },
        MMM: function (d, o) {
            return o.jmonthNamesShort[d.getJalaliMonth()]
        },
        MMMM: function (d, o) {
            return o.jmonthNames[d.getJalaliMonth()]
        },
        yy: function (d) {
            return (d.getJalaliFullYear() + '').substring(2)
        },
        yyyy: function (d) {
